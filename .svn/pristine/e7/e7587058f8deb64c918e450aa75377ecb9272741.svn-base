...
public class Tweet extends BaseActivity {
    ...
    {    	
    	...
    	if (preferences != null) {
			mEditText.setText(preferences.getString(TEMP_TEXT_KEY, null));
			// 设置光标位置
			mEditText.setSelection(preferences.getString(TEMP_TEXT_KEY, null).length());
			//显示临时保存图片
...
//					this.getString(R.string.img_from_camera)
	...
	private View.OnClickListener publishClickListener = new View.OnClickListener() {
		public void onClick(View v) {	
			//隐藏软键盘
			imm.hideSoftInputFromWindow(v.getWindowToken(), 0);  
			String str = Tweet.this.mEditText.getText().toString();
...
//			 public void run()
//			 {
//			 Log.v("Tweet", "startAsyTask");
//			 try
//			 {
//			 if (Tweet.isSina.booleanValue())
//			 {
//			 if (Tweet.this.uri == null)
//			 break label207;
//			 Tweet.this.update,Tweet.this.path, "", "");
//			 }
//			 while (true)
//			 {
//			 if (Tweet.isTencent.booleanValue())
//			 {
//			 if (Tweet.this.uri == null)
//			 break;
//			 Tweet.this.update(BaseActivity.getInstance(), this.val$text,
//			 Tweet.this.path, "127.0.0.1");
//			 }
//			 Tweet.this.message = new Message();
//			 Tweet.this.message.what = 1;
//			 Tweet.this.mHandler.sendMessage(Tweet.this.message);
//			 SharedPreferences.Editor localEditor =
//			 Tweet.this.preferences.edit();
//			 localEditor.clear();
//			 localEditor.commit();
//			 Log.v("Tweet", "finishAsyTask");
//			 return;
//			 label207: Tweet.this.update(this.val$text, "", "", "");
//			 }
//			 }
