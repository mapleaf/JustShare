...
public abstract class BaseActivity extends Activity {
	...
	public String getQMentionsTimeLine() {
		String rlt = "";
		try {
			rlt = mStatusesAPI.mentionsTimeline(oAuth, FORMAT, "0", "0",
					REQNUM, "0", TYPE, CONTENTTYPE);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public String getQUserTimeLine() {
		String rlt = "";
		try {
			rlt = mStatusesAPI.broadcastTimeline(oAuth, FORMAT, "0", "0",
					REQNUM, "0", TYPE, CONTENTTYPE);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	public String update(String status, String lon, String lat)
		...
		weiboRunner.request(BaseActivity.this, url, bundle,
				Utility.HTTPMETHOD_POST, new RequestListener() {
